	...
	apply_filters(
		...
		array(
			...
			'on_error' => array(
				...
				'display_error'   => '<div class="bs-pages-error-section"><a href="#" class="btn bs-pages-error-copy" data-copied="' . esc_attr__( 'Copied !', 'publisher' ) . '"><i class="fa fa-files-o" aria-hidden="true"></i> ' . __( 'Copy', 'publisher' ) . '</a>  <textarea> ' . __( 'Error', 'publisher' ) . ':  %ERROR_MSG% | Error Code: %ERROR_CODE% </textarea></div>',
			)
		)
	)
);
