...
class Publisher_Translation {
	...
	public static function change_translation( $lang, $current_lang = null ) {
		 ...
		 *
		 */
		do_action( 'publisher-theme-core/translation/change-translation/before', $lang, $languages );

		$translation = self::get_language_translation( $lang );
		...
		$result = array(
			'status'  => 'succeed',
			'msg'     => sprintf( __( 'Theme translation changed to "%s"', 'publisher' ), $languages[ $lang ]['name'] ),
			'refresh' => true
		);
