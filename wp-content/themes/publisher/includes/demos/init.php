...
if ( ! function_exists( 'publisher_demos_config' ) ) {
	...
	function publisher_demos_config( $data = array() ) {
		...
		$data['fribourg-blog']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/fribourg-blog/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Fribourg Blog', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/fribourg-blog/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['future-mag']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/future-mag/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Future Mag', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/future-mag/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['food-recipes']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/food-recipes/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Food Recipes', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/food-recipes/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['clean-news']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/clean-news/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Clean News', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/clean-news/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['magz']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/magz/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Magz', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/magz/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['light-mag']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/light-mag/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Light Mag', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/light-mag/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['magly']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/magly/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Magly', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/magly/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['news-look']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/news-look/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'News Look', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/news-look/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['news-plus']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/news-plus/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'News Plus', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/news-plus/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['news-time']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/news-time/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'News Time', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/news-time/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['personal-blog']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/personal-blog/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Personal Blog', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/personal-blog/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['smart-news']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/smart-news/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Smart News', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/smart-news/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['technet']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/technet/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Tech Net', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/technet/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['top-stories']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/top-stories/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Top Stories', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/top-stories/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['trend-mag']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/trend-mag/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Trend Mag', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/trend-mag/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['game-report']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/game-report/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Game Report', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/game-report/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['game-storm']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/game-storm/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Game Storm', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/game-storm/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['games-plus']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/games-plus/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Games Plus', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/games-plus/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['games-watch']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/games-watch/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Games Watch', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/games-watch/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['global-mag']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/global-mag/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Global Mag', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/global-mag/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['good-mag']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/good-mag/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Good Mag', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/good-mag/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
		$data['hipster-blog']    = array(
			'thumbnail'   => PUBLISHER_THEME_URI . 'includes/demos/hipster-blog/thumbnail.jpg?v=' . PUBLISHER_THEME_VERSION,
			'name'        => __( 'Hipster Blog', 'publisher' ),
			'preview_url' => 'http://demo.betterstudio.com/publisher/hipster-blog/',
			'options'     => true,
			'badges'      => array( __( 'New', 'publisher' ) ),
		);
