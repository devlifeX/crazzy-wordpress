 ...
 * Publisher -> News Plus
 */
class Publisher_Theme_Style_News_Plus extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/news-plus/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/news-plus/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-news-plus',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'news-plus/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'news-plus/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-news-plus' );
	}
...
} // Publisher_Theme_Style_News_Plus