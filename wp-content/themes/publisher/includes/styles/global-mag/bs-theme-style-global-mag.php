...
/**
 * Publisher -> Global Mag
 */
class Publisher_Theme_Style_Global_Mag extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/global-mag/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/global-mag/panel-css.php';
...
//		);
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-global-mag',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'global-mag/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'global-mag/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-global-mag' );
	}
...
} // Publisher_Theme_Style_Global_Mag
