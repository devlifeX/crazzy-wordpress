...
/**
 * Publisher -> Games_Watch
 */
class Publisher_Theme_Style_Games_Watch extends Publisher_Theme_Style {
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-games-watch',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'games-watch/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'games-watch/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-games-watch' );
	}
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/games-watch/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/games-watch/panel-css.php';
...
} // Publisher_Theme_Style_Games_Watch
