...
/**
 * Publisher -> Game Report
 */
class Publisher_Theme_Style_Game_Report extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/game-report/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/game-report/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-game-report',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'game-report/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'game-report/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-game-report' );
	}
...
} // Publisher_Theme_Style_Game_Report
