<?php
//
// Custom default values for people-magazine Demo
// 
...
$fields['section_heading_style'][ $std_id ] = 't6-s7';
...
$fields['theme_color'][ $std_id ] = '#166ae8';
...
$fields['topbar_bg_color'][ $std_id ] = '#111111';
$fields['topbar_border_color'][ $std_id ] = '#111111';
...
$fields['typo_post_tp6_heading'][ $std_id ] = '33px';
$fields['typo_post_tp7_heading'][ $std_id ] = '33px';
$fields['typo_post_tp8_heading'][ $std_id ] = '33px';
$fields['typo_post_tp9_heading'][ $std_id ] = '33px';
$fields['typo_post_tp10_heading'][ $std_id ] = '33px';
$fields['typo_post_tp11_heading'][ $std_id ] = '32px';
$fields['typo_post_tp12_heading'][ $std_id ] = '31px';
$fields['typo_post_tp13_heading'][ $std_id ] = '31px';
