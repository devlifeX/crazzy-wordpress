...
/**
 * Publisher -> Food Recipes
 */
class Publisher_Theme_Style_Food_Recipes extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/food-recipes/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/food-recipes/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-food-recipes',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'food-recipes/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'food-recipes/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-food-recipes' );
	}
...
} // Publisher_Theme_Style_Food_Recipes