...
/**
 * Publisher -> Hipster Blog
 */
class Publisher_Theme_Style_Hipster_Blog extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/hipster-blog/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/hipster-blog/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-hipster-blog',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'hipster-blog/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'hipster-blog/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-hipster-blog' );
	}
...
} // Publisher_Theme_Style_Hipster_Blog
