<?php
//
// Custom default values for light-mag Demo
// 
...
$fields['injection_after_header'][ $std_id ] = '516';
$fields['theme_color'][ $std_id ] = '#309bd3';
...
$fields['header_menu_btop_color'][ $std_id ] = '#f0f0f0';
$fields['header_menu_st2_bbottom_color'][ $std_id ] = '#f0f0f0';
...
$fields['footer_social_bg_color'][ $std_id ] = '#0e0e0e';
$fields['footer_bg_color'][ $std_id ] = '#0e0e0e';
$fields['widgets_heading_style'][ $std_id ] = 't3-s4';
$fields['section_title_color'][ $std_id ] = '#0e0e0e';
$fields['section_title_bg_color'][ $std_id ] = '#0e0e0e';
