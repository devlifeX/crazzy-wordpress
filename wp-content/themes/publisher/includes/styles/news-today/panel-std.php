<?php
//
// Custom default values for news-today Demo
// 
...
$fields['section_heading_style'][ $std_id ] = 't5-s2';
...
$fields['header_menu_item_h_bg_color'][ $std_id ] = '#bd000c';
$fields['header_menu_bg_color'][ $std_id ] = '#d4000e';
$fields['footer_link_color'][ $std_id ] = '#d1d0d0';
$fields['footer_link_hover_color'][ $std_id ] = '#ffffff';
$fields['footer_menu_bg_color'][ $std_id ] = '#1f1f1f';
$fields['footer_copy_bg_color'][ $std_id ] = '#060606';
$fields['footer_social_bg_color'][ $std_id ] = '#060606';
$fields['footer_bg_color'][ $std_id ] = '#060606';
$fields['widgets_heading_style'][ $std_id ] = 't3-s4';
$fields['section_title_color'][ $std_id ] = '#000000';
$fields['section_title_bg_color'][ $std_id ] = '#191919';
