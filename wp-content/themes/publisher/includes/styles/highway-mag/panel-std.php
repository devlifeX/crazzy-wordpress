<?php
//
// Custom default values for highway-mag Demo
// 
...
$fields['theme_color'][ $std_id ] = '#5080ad';
$fields['site_bg_color'][ $std_id ] = '#4b5a42';
$fields['topbar_text_color'][ $std_id ] = '#959595';
$fields['topbar_text_hcolor'][ $std_id ] = '#6d6d6d';
...
$fields['topbar_icon_text_hcolor'][ $std_id ] = '#6d6d6d';
...
$fields['header_menu_item_h_bg_color'][ $std_id ] = '#5080ad';
...
$fields['footer_menu_bg_color'][ $std_id ] = '#212121';
$fields['footer_copy_bg_color'][ $std_id ] = '#2b2b2b';
$fields['footer_social_bg_color'][ $std_id ] = '#2b2b2b';
$fields['footer_bg_color'][ $std_id ] = '#2b2b2b';
$fields['section_title_color'][ $std_id ] = '#363636';
$fields['section_title_bg_color'][ $std_id ] = '#5080ad';
