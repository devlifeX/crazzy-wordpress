...
/**
 * Publisher -> Highway Mag
 */
class Publisher_Theme_Style_Highway_Mag extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/highway-mag/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/highway-mag/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-highway-mag',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'highway-mag/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'highway-mag/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-highway-mag' );
	}
...
} // Publisher_Theme_Style_Highway_Mag