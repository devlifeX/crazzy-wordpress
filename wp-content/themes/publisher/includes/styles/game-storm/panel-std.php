<?php
//
// Custom default values for game-storm Demo
// 
...
$fields['theme_color'][ $std_id ] = '#ca124a';
...
$fields['topbar_text_hcolor'][ $std_id ] = '#f4f4f4';
$fields['topbar_bg_color'][ $std_id ] = '#050e28';
...
$fields['header_bg_color'][ $std_id ] = '#07143a';
$fields['footer_link_color'][ $std_id ] = '#858585';
...
$fields['footer_bg_image'][ $std_id ] = array (
  'type' => 'cover',
  'img' => 'https://demo.betterstudio.com/publisher/game-storm/wp-content/uploads/sites/489/2018/11/footer-game-storm.png',
);
