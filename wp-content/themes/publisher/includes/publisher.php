...
class Publisher {
	...
	function __construct() {
		...
		// add aparat support
		wp_embed_register_handler( 'aparat', '#^https?://(?:www)\.aparat\.com\/v\/([^\/]+)#i', [
			__CLASS__,
			'aparat_embed'
		] );
	...
	/**
     * Aparat iframe embed handler callback.
     *
	 * @param array $matched
     *
     * @since 7.11
	 */
	public static function aparat_embed( $matched ) {
	    ob_start();
	    ?>
        <style>.h_iframe-aparat_embed_frame {position: relative;}.h_iframe-aparat_embed_frame .ratio {display: block;width: 100%;height: auto;}.h_iframe-aparat_embed_frame iframe {position: absolute;top: 0;left: 0;width: 100%;height: 100%;border: none;}</style>
        <div class="h_iframe-aparat_embed_frame">
            <span style="display: block;padding-top: 57%"></span>
            <iframe src="https://www.aparat.com/video/video/embed/videohash/<?php echo esc_attr($matched[1]) ?>/vt/frame" allowFullScreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
        </div>
		<?php
